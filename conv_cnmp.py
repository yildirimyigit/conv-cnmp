...
class ConvCNMP(nn.Module):                # input size of default conv1 is 3 because it is (R,G,B)
    def __init__(self, conv_layers: list = [[3,32,3,1,0], [32,64,3,1,0], [64,64,3,1,0]], conv_image_height:int = 32, 
            conv_image_width: int = 32, pool_kernel_size: int = 2, pool_stride: int = 2, linear_output_sizes: list = [64,10], 
            cnmp_input_dim: int = 1, cnmp_encoder_hidden_dims: list = [256,256,256], cnmp_decoder_hidden_dims: list = [128,128,128], 
